...
export  const currenciesListContainerS = "absolute z-40 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
export const currenciesListItemS = "hover:cursor-pointer hover:bg-gray-100 text-gray-700 block px-4 py-2 text-sm"
